...
const DOC_TITLES = new Map([
  ...
  ["/docs/plugins/claude", "Claude Code Plugin"],
  ["/docs/plugins/codex", "Codex Plugin"],
  ...
  ["/docs/reference/agent-runtimes/claude", "Claude Agent Runtime"],
...
const DOC_ICON_NAMES = new Map([
  ...
  ["/docs/library", "FaBook"],
  ["/docs/memory", "FaBrain"],
  ["/docs/plugins", "FaRobot"],
  ["/docs/plugins/claude", "FaRobot"],
  ["/docs/plugins/codex", "FaRobot"],
  ...
  ["/docs/reference/embedding-providers", "FaChartLine"],
]);
