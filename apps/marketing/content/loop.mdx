...
- [Attention Agent](/docs/attention-agent) — the Loomi widget that surfaces Loop's decision cards
- [Memory](/docs/memory) — the holistic context Loop reads from and writes to
- [Connectors](/docs/connectors) — the signal sources that feed Loop's tick
- [Automation](/docs/automation) — schedule the brief, wrap, and tick jobs
- [Chat](/docs/chat) — where Edit Draft hands off into the OpenLoomi chat
- [Privacy & Security](/docs/privacy-security#audit-logs) — where every Loop tick is recorded
- [Skills](/docs/skills) — the legacy `openloomi-loop` skill interface
