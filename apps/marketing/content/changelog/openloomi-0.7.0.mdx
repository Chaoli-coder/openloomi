...
description: "OpenLoomi 0.7.0 release notes — AI coworker experience, Loomi desktop pet, integrated Loop, memory intelligence upgrade"
icon: "FaBolt"
---
...
- **Screen Capture Retry**: Retries macOS screen capture on transient `CGWindowList` errors
...
- [Loop](/docs/loop) — the proactive execution engine introduced in this release
- [Memory](/docs/memory) — the memory intelligence upgrade
- [Attention Agent](/docs/attention-agent) — the Loomi pet introduced in this release
- [Privacy & Security](/docs/privacy-security) — the new privacy documentation
- [Agent Runtimes](/docs/reference/agent-runtimes) — OpenCode, Hermes, OpenClaw providers
- [OpenLoomi CLI](/docs/reference/openloomi-ctl) — the renamed `openloomi-ctl` binary
- [Changelog](/docs/changelog) — full release history
- [GitHub Release](https://github.com/melandlabs/openloomi/releases/tag/v0.7.0) — raw build artifacts
