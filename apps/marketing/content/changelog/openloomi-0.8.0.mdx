...
description: "OpenLoomi 0.8.0 release notes — unified IM decision type, graph-driven memory consolidation, hardened plugin setup"
icon: "FaBolt"
---
...
- [Loop](/docs/loop) — where `im_reply` and `slack_reply` are classified and surfaced
- [Memory](/docs/memory) — graph-driven consolidation
- [Claude Code Plugin](/docs/plugins/claude) · [Codex Plugin](/docs/plugins/codex) — the plugin setup improvements
- [OpenLoomi CLI](/docs/reference/openloomi-ctl) — the packaged one-shot runner
- [Changelog](/docs/changelog) — full release history
- [GitHub Release](https://github.com/melandlabs/openloomi/releases/tag/v0.8.0) — raw build artifacts
