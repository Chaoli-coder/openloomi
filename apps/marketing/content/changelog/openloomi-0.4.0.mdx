...
- [Memory](/docs/memory) — the Forgetting Pipeline introduced in this release
- [Automation](/docs/automation) — the interval-based scheduling
- [Skills](/docs/skills) — the Marketplace skills directory
- [Library](/docs/library) — the document preview capabilities
- [Changelog](/docs/changelog) — full release history
- [GitHub Release](https://github.com/melandlabs/openloomi/releases/tag/v0.4.0) — raw build artifacts
