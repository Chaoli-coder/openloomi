---
title: "OpenLoomi 0.5.0"
description: "OpenLoomi 0.5.0 release notes — unified vector search, platform connectors ecosystem, AI skills library"
icon: "FaBolt"
---
...
- [Memory](/docs/memory) — the unified vector search introduced in this release
- [Connectors](/docs/connectors) — the platform connectors ecosystem
- [Skills](/docs/skills) — the AI skills library
- [Library](/docs/library) — the enhanced document previews
- [Changelog](/docs/changelog) — full release history
- [GitHub Release](https://github.com/melandlabs/openloomi/releases/tag/v0.5.0) — raw build artifacts
