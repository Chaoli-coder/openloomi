...
- [Agent Runtimes](/docs/reference/agent-runtimes) — pick the runtime that executes the CLI tasks
- [Reference](/docs/reference) — back to the Reference index
- [Skills](/docs/skills) — the reusable capabilities this CLI can drive
- [Getting Started](/docs/getting-started) — install + first run
- [Privacy & Security](/docs/privacy-security) — what the CLI can read
