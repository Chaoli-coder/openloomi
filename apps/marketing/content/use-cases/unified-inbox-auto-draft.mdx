...
- [Connectors](/docs/connectors) — wiring up email + messaging platforms
- [Memory](/docs/memory) — the cross-thread context drafts are grounded in
- [Loop](/docs/loop) — turns inbox signals into reply drafts
- [Chat](/docs/chat) — where you can refine a draft before approving
- [Privacy & Security](/docs/privacy-security) — what the inbox connectors can see
