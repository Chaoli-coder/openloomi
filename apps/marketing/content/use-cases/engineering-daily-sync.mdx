...
- [Automation](/docs/automation) — the scheduler behind the daily brief and issue sync
- [Loop](/docs/loop) — the engine that turns GitHub / Linear signals into decision cards
- [Connectors](/docs/connectors) — wiring up GitHub and Linear OAuth
- [Memory](/docs/memory) — the team context Loop enriches with
- [Attention Agent](/docs/attention-agent) — where the PR-review bubble lands
