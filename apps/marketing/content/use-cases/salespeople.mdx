...
|                   |                                                                           |
| ----------------- | ------------------------------------------------------------------------- |
| **Persona**       | RevOps lead coordinating deals across HubSpot, Slack, email               |
| **Goal**          | Stop doing pipeline archaeology every Friday                              |
| **Prerequisites** | HubSpot connector authorized; HubSpot registered as a custom Loop channel |
| **Outcome**       | Deal signals flow into the queue, drafts are approval-gated               |
...
- [Loop](/docs/loop) — the deal-signal engine
- [Connectors](/docs/connectors) — wiring HubSpot + Slack + email
- [Memory](/docs/memory) — the prospect history drafts are grounded in
- [Automation](/docs/automation) — schedule the weekly pipeline rollup
- [Attention Agent](/docs/attention-agent) — where high-value deal signals bubble
