...
|                   |                                                                                    |
| ----------------- | ---------------------------------------------------------------------------------- |
| **Persona**       | Content creator / community manager running an AI-focused X account                |
| **Goal**          | Stop drafting from scratch every Sunday — let Loop watch X signals                 |
| **Prerequisites** | X connector authorized; a few sample posts shared with Memory so the voice carries |
| **Outcome**       | Drafts in your voice, queued for explicit Approve before anything posts            |
...
- [Loop](/docs/loop) — the X-channel signal source
- [Connectors](/docs/connectors) — wiring the X / Twitter connector
- [Memory](/docs/memory) — carries your voice across sessions
- [Attention Agent](/docs/attention-agent) — where high-priority mentions surface
- [Skills](/docs/skills) — the x-twitter-api skill referenced above
