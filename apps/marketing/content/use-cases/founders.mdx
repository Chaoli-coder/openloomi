...
|                   |                                                                                         |
| ----------------- | --------------------------------------------------------------------------------------- |
| **Persona**       | Seed-stage founder doing investor intros, partner pitches, customer follow-ups          |
| **Goal**          | Stop losing follow-ups across hundreds of contacts                                      |
| **Prerequisites** | Email + LinkedIn / messaging connectors authorized; Memory carries prior conversations  |
| **Outcome**       | Drafts grounded in the relationship history, approval still yours before anything sends |
...
- [Loop](/docs/loop) — the relationship-aware judgement engine
- [Memory](/docs/memory) — the contact history drafts are grounded in
- [Connectors](/docs/connectors) — wiring email, LinkedIn, messaging apps
- [Chat](/docs/chat) — where you refine a draft before approving
- [Privacy & Security](/docs/privacy-security) — where the BD data lives
