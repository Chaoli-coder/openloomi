...
|                   |                                                                          |
| ----------------- | ------------------------------------------------------------------------ |
| **Persona**       | Analyst tracking AI launches across X, Product Hunt, Reddit, RSS         |
| **Goal**          | Stop re-researching last week's launches — let Memory carry the research |
| **Prerequisites** | Custom channels registered for the non-built-in sources; Loop is on      |
| **Outcome**       | A Friday Brief that ranks the launches worth caring about                |
...
- [Loop](/docs/loop) — the engine that polls the custom channels
- [Connectors](/docs/connectors) — wiring the built-in sources
- [Memory](/docs/memory) — long-term retention of the launches you've read
- [Automation](/docs/automation) — the Friday Brief schedule
- [Skills](/docs/skills) — the x-twitter-api / composio-cli skills this story references
