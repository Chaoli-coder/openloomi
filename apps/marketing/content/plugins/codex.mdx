...
![Loop card — EMAIL_REPLY for the Q3 OKR status email](/img/openloomi/plugins/codex/22-loop-draft-reply.png)

![Loop card — EMAIL_REPLY expanded with Subject and Body reply editor](/img/openloomi/plugins/codex/23-loop-draft-reply-expanded.png)
...
- [Connectors](/docs/connectors) — what the Codex plugin can reach
- [Memory](/docs/memory) — what the Codex plugin reads from
