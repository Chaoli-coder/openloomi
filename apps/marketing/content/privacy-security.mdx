...
- [Memory](/docs/memory) — where your local data lives
- [Connectors](/docs/connectors) — what each platform connector actually accesses
- [Loop](/docs/loop) — where every judgement and execution lands in audit
- [Automation](/docs/automation) — schedules and execution history
- [Embedding Providers](/docs/reference/embedding-providers) — local vs cloud embedding choices
